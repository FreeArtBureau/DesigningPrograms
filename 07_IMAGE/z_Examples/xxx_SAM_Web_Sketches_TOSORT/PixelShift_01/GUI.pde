...
void ControlInit() {
   ...
   */
  Slider r = INTERFACES.addSlider("INDEXRED").setPosition(10, 40).setRange(1, 255).setValue(60);  // ici on a rajouté aussi la valeur de départ avec la méthode setValue(30);
  Slider g = INTERFACES.addSlider("INDEXGREEN").setPosition(10, 60).setRange(1, 255).setValue(30); 
  Slider b = INTERFACES.addSlider("INDEXBLUE").setPosition(10, 80).setRange(1, 255).setValue(15); 

  Slider x = INTERFACES.addSlider("TRAMEX").setPosition(10, 120).setRange(1, 20).setValue(8);
  Slider y = INTERFACES.addSlider("TRAMEY").setPosition(10, 140).setRange(1, 20).setValue(14);
